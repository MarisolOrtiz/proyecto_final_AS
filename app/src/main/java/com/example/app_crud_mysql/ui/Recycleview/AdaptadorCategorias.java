package com.example.app_crud_mysql.ui.Recycleview;
...
//(AdaptorArticulos).
    public AdaptadorCategorias(Context mCtx, List<dto_categorias> categoriaList) {
        this.mCtx = mCtx;
...
*/
    ...
    public CategoriasViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.adaptador_categoria, null);
   ...
   //     Toast.LENGTH_SHORT).show();
        dto_categorias dto = categoriaList.get(position);
        holder.textViewId.setText(String.valueOf(dto.getId_categoria()));
        holder.textViewNombre.setText(dto.getNom_categoria());
        holder.textViewEstado.setText(String.valueOf(dto.getEstado_categoria()));
